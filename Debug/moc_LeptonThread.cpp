...
#include "../Thermal_Stitcher_Proj/Third-Party/Lepton/LeptonThread.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_LeptonThread_t, stringdata) + ofs \
...
void LeptonThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (LeptonThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LeptonThread::updateText)) {
                *result = 0;
            }
        }
        {
            typedef void (LeptonThread::*_t)(QImage );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LeptonThread::updateImage)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject LeptonThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_LeptonThread.data,
      qt_meta_data_LeptonThread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LeptonThread.stringdata))
